...
- (void)layoutSubviews
{
    ...
    // 圆角
    UIBezierPath *path= [UIBezierPath bezierPathWithRoundedRect:f byRoundingCorners:(UIRectCornerTopLeft | UIRectCornerTopRight | UIRectCornerBottomLeft | UIRectCornerBottomRight) cornerRadii:s];
...
- (void)screenshot
{
    ...
    gradientLayer.colors =
     @[(__bridge id)HEX(@"#7BE3C4").CGColor,
                             (__bridge id)HEX(@"#7BE3C4").CGColor];
    //@[HEX(@"#7BE3C4"),HEX(@"#7BE3C4")];
