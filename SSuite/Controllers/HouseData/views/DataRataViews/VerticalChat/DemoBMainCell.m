...
- (void)barModel:(HistogramModel *)model maxValue:(double)max
{
    ...
    // 临时赋值frame
    self.barView.frame = CGRectMake(self.frame.size.width/2-BAR_cW/2, BAR_cH - 20, BAR_cW, 0.5);
    ...
    CGRect f = CGRectMake(self.frame.size.width/2-BAR_cW/2, BAR_cH - h - 20, BAR_cW, h);
